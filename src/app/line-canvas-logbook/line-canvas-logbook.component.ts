...
@Component({
  selector: 'app-line-canvas-logbook',
  templateUrl: './line-canvas-logbook.component.html',
  styleUrls: ['./line-canvas-logbook.component.css']
})

export class LineCanvasLogbookComponent implements OnInit {
